...
#' "KEGG". Defaults to "GO".
#' @param array.type The Illumina methylation array used. Options are "450K", "EPIC" or
#' "EPIC_V2". Defaults to "450K".
...
.getFlatAnnotation <- function(array.type=c("450K","EPIC", "EPIC_V2"),anno=NULL)
